    ...
    function create_fragment$e(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (default_slot) default_slot.c();
    			attr_dev(button, "class", "svelte-15izo7g");
    			toggle_class(button, "selected", /*$selectedTab*/ ctx[0] === /*tab*/ ctx[1]);
    			add_location(button, file$c, 40, 0, 710);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_each_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "ca svelte-14mb7ua");
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			attr_dev(div0, "class", "he svelte-14mb7ua");
    			add_location(div0, file$5, 20, 4, 581);
    			attr_dev(div1, "class", "ti svelte-14mb7ua");
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			if (if_block) if_block.c();
    			attr_dev(div, "class", "container svelte-14mb7ua");
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div1, "class", "list svelte-58lemi");
